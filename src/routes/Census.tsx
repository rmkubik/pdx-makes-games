...
export const Census = () => {
  return (
    <>
      ...
      <Section>
        <Heading as="h3">Game events</Heading>
        <Heading as="h4">What games-related events have you attended?</Heading>
        <span>
          {
            csv.getColumnByTitle("What games-related events have you attended?")
              .answerCount
          }{" "}
          responses
        </span>
        <p>
          Many responders mentioned private or invite only communities. Only the
          events with public facing information are listed below.
        </p>
        <Columns
          columns={2}
          items={unique([
      ...
      <Section>
        ...
        <p>Several of these communities no longer appear to be operational.</p>
        <Columns
          columns={2}
          items={unique([
            "PIGSquad",
      ...
      <Section>
        ...
        <p>
          Here are the links everyone shared during the survey. If you'd like to
          remove your links please reach out!
        </p>
        <List
          items={[
            <a
